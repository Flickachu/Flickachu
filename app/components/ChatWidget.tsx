...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      <div 
        className="fixed bottom-8 right-24 z-50 flex items-center group"
      ...
      >
        ...
        >
          ...
          {open ? <X size={18} className="text-black relative z-10" /> : <MessageSquare size={18} className="text-[#a27725] relative z-10" />}
        </button>
      </div>

      {open && (
        <div className="fixed bottom-24 right-8 z-[49] w-[340px] h-[500px] max-h-[75vh] rounded-2xl overflow-hidden shadow-2xl border border-black/10 bg-white/90 backdrop-blur-xl flex flex-col origin-bottom-right transition-all animate-in slide-in-from-bottom-4 fade-in duration-300">
